package com.Azizi.Facehappyness.lib;
...
public class Smile extends View {
    ...
    private SmileRatingListener mListener;
    ...
    // re-calculate eye and mouth position
    ...
    public void setListener(SmileRatingListener listener) {
...
//        }
    ...
    public interface SmileRatingListener {
        ...
        void onRatingChange(Smile peterSmileRating, int rate);
